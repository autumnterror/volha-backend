...
const file_domain_proto_rawDesc = "" +
	...
	"\aarticle\x18\x03 \x01(\tR\aarticle\"4\n" +
	"\tBrandList\x12'\n" +
	...
	"categories\">\n" +
	"\vCountryList\x12/\n" +
	"\tcountries\x18\x01 \x03(\v2\x11.products.CountryR\tcountries\"@\n" +
	"\fMaterialList\x120\n" +
	"\tmaterials\x18\x01 \x03(\v2\x12.products.MaterialR\tmaterials\"4\n" +
	"\tColorList\x12'\n" +
	"\x06colors\x18\x01 \x03(\v2\x0f.products.ColorR\x06colors\"f\n" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12\x10\n" +
	"\x03hex\x18\x03 \x01(\tR\x03hex\"\xc9\x03\n" +
	...
	"\tmax_depth\x18\f \x01(\x05R\bmaxDepthB3Z1github.com/autumnterror/volha-backend;productsRPCb\x06proto3"
...
var file_domain_proto_goTypes = []any{
	...
	(*DictionariesByCategory)(nil), // 22: products.DictionariesByCategory
}
var file_domain_proto_depIdxs = []int32{
	13, // 0: products.ProductList.products:type_name -> products.Product
	17, // 1: products.BrandList.brands:type_name -> products.Brand
	18, // 2: products.CategoryList.categories:type_name -> products.Category
	19, // 3: products.CountryList.countries:type_name -> products.Country
	20, // 4: products.MaterialList.materials:type_name -> products.Material
	21, // 5: products.ColorList.colors:type_name -> products.Color
	...
	4,  // 18: products.DictionariesByCategory.brands:type_name -> products.BrandList
	6,  // 19: products.DictionariesByCategory.countries:type_name -> products.CountryList
	7,  // 20: products.DictionariesByCategory.materials:type_name -> products.MaterialList
	8,  // 21: products.DictionariesByCategory.colors:type_name -> products.ColorList
