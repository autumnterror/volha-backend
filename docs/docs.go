...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/productsRPC.ProductColorPhotosId"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/country": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Обновлённая страна",
                        "name": "country",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/dictionaries/all/by-category": {
            "get": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "успех",
                        "schema": {
                            "$ref": "#/definitions/productsRPC.Product"
                        }
                    },
                    "502": {
                        "description": "ошибка в микросервисе",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/productsRPC.ProductId"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/productsRPC.ProductFilter"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/slide": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Обновлённые данные слайда",
                        "name": "material",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "productsRPC.ProductColorPhotos": {
            "type": "object",
            "properties": {
                "color_id": {
                    "type": "string"
        ...
        "productsRPC.ProductColorPhotosId": {
            "type": "object",
            "properties": {
                "color_id": {
                    "type": "string"
